...
export function PlayingCard({ card, hidden = false, delay = 0, small = false, made = false, draw = false }: { card?: CardType; hidden?: boolean; delay?: number; small?: boolean; made?: boolean; draw?: boolean }) {
  ...
  return (
    <div className={`playing-card ${red ? "red" : "black"} ${small ? "small" : ""} ${made ? "coach-made" : ""} ${draw ? "coach-draw" : ""}`} style={{ animationDelay: `${delay}ms` }}>
