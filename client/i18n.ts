...
const en = {
  ...
  handLog: "HAND LOG", stats: "STATS", debug: "DEBUG", previousHands: "Previous hands", handsPlayed: "Hands played", handsWon: "Profitable hands", handsWithPayout: "Hands with a payout", potsWon: "Pots won", showdownsWon: "Showdowns with a payout", biggestPot: "Biggest pot",
  aggression: "Aggression", netChips: "Net chips", chipGraph: "CURRENT SESSION · CHIP GRAPH", tendencies: "OBSERVED TENDENCIES",
...
const ru: Record<TranslationKey, string> = {
  ...
  handLog: "ИСТОРИЯ", stats: "СТАТИСТИКА", debug: "ОТЛАДКА", previousHands: "Предыдущие раздачи", handsPlayed: "Сыграно раздач", handsWon: "Прибыльные раздачи", handsWithPayout: "Раздачи с выплатой", potsWon: "Выиграно банков", showdownsWon: "Вскрытия с выплатой", biggestPot: "Самый большой банк",
  aggression: "Агрессия", netChips: "Результат", chipGraph: "ТЕКУЩАЯ СЕССИЯ · ГРАФИК ФИШЕК", tendencies: "ЗАМЕЧЕННЫЕ ТЕНДЕНЦИИ",
